...
- **Photos and links per conversation**: a grid of everything anybody sent, grouped by month and fetched only as you scroll to it, and a list of every link with who sent it and what they said around it. Both are read off the device — no favicon fetch, no title lookup, no unfurl service, because a list that quietly asked a third party for an icon would hand over the one thing the encryption is for.
